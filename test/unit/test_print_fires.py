...
class TestMathLib(unittest.TestCase):
    ...
    def test_mean(self):
        ...
        self.assertEqual(my_utils.mean([2, 5, 6, 9, 12, 7]),
                         np.mean([2, 5, 6, 9, 12, 7]))
    ...
    def test_random_mean(self):
        for i in range(0, 10):
            ...
            self.assertEqual(my_utils.mean(random_array),
    ...
    def test_median(self):
        ...
        self.assertEqual(my_utils.median([2, 5, 6, 9, 12, 7]),
                         np.median([2, 5, 6, 9, 12, 7]))  # out of order list
    ...
    def test_random_median(self):
        for i in range(0, 10):
            length = random.randint(1, 100)
            random_array = [random.randint(1, 99) for _ in range(length)]
            self.assertEqual(my_utils.median(random_array),
    ...
    def test_stdev(self):
        ...
        self.assertEqual(my_utils.stdev([10, 1, 20, 13, 5, 12, 11]),
                         np.std([10, 1, 20, 13, 5, 12, 11]))
    ...
    def test_random_stdev(self):
        for i in range(0, 10):
            ...
            random_array = [random.randint(1, 99) for _ in range(length)]
            self.assertAlmostEqual(my_utils.stdev(random_array),
                                   np.std(random_array))
