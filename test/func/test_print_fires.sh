...
## Error Cases ##
run test_file_not_found python src/print_fires.py -f 'file.csv' -c 'Any' -cc 'Any' -fc 'Any'
assert_in_stderr "Could not find file: file.csv"
assert_exit_code 0

run test_bad_query_column python src/print_fires.py -f 'test_data.csv' -c 'USA' -cc 'bad_col' -fc 'Forest fires'
assert_in_stderr "substring not found"
assert_exit_code 1

run test_bad_result_column python src/print_fires.py -f 'test_data.csv' -c 'United States of America' -cc 'Area' -fc 'Bad_Fires'
assert_in_stderr "Bad_Fires column not in test_data.csv"
assert_exit_code 0

run test_empty_array python src/print_fires.py -f 'test_data.csv' -c 'Not a Country' -cc 'Area' -fc 'Forest fires' -o 'mean'
assert_in_stdout "[]"
